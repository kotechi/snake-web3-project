...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CCWZWD4BH6Y7NIIVWSHKRFERRDZPKIDRBF5WTOCTGD2XYXG3L6MYCHXY";
    };
};
...
export interface Client {
     ...
     */
    initialize: ({ admin, token_address, entry_fee }: {
        admin: string;
     ...
     */
    create_competition: ({ admin, session_id, deadline }: {
        admin: string;
        session_id: u32;
        deadline: u64;
    }, options?: {
     ...
     */
    update_entry_fee: ({ admin, new_fee }: {
        admin: string;
        new_fee: i128;
    }, options?: {
        /**
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        create_competition: (json: string) => AssembledTransaction<null>;
        play_game: (json: string) => AssembledTransaction<null>;
        end_competition: (json: string) => AssembledTransaction<null>;
        get_competition: (json: string) => AssembledTransaction<Option<Competition>>;
        get_leaderboard: (json: string) => AssembledTransaction<PlayerScore[]>;
        get_player_stats: (json: string) => AssembledTransaction<Option<PlayerScore>>;
        get_entry_fee: (json: string) => AssembledTransaction<bigint>;
        get_admin: (json: string) => AssembledTransaction<string>;
        update_entry_fee: (json: string) => AssembledTransaction<null>;
    };
}
